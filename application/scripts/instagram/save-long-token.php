...
mysqli_query($jobConn, "UPDATE candidate SET instagram_key = '$token' WHERE user_id = $user_id") or die("Error: " . mysqli_error($jobConn));

header("Location: ../../candidate-profile?hasToken=true&id=".$user_id);
