...
mysqli_query($jobConn, "UPDATE employer SET instagram_key = '$instagram_token' WHERE user_id = $user_id") or die("Error: " . mysqli_error($jobConn));
mysqli_query($jobConn, "UPDATE employer SET instagram_id = '$instagram_user_id' WHERE user_id = $user_id") or die("Error: " . mysqli_error($jobConn));

header("Location: get-long-token-employer");
?>