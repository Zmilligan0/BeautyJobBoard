...
if(isset($_POST['filter'])){
    ...
    if (isset($_POST['status_search'])){
        ...
        $search_part3 = "AND (job.status LIKE '%$status_search%')";
    } else {
        $status_search = "";
        $search_part3 = "";
    }
...
$candidate_id = "";
$sql= "SELECT first_name, last_name, candidate_id From candidate WHERE user_id = '$_SESSION[user_id]'";
...
where saved_job.candidate_id = $candidate_id $search_part1 $search_part2 $search_part3");
...
$result = mysqli_query($jobConn,"SELECT saved_job.job_id,title, job.city, job.province, employment_type, job.status,business_name From saved_job 
inner join job on saved_job.job_id = job.job_id
inner join employer on job.employer_id = employer.employer_id 
where saved_job.candidate_id = $candidate_id LIMIT $offset , $limit") or die(mysqli_error($jobConn));
if(isset($_POST['filter'])){
    $result = mysqli_query($jobConn,"SELECT saved_job.job_id,title, job.city, job.province, employment_type, job.status,business_name From saved_job 
    inner join job on saved_job.job_id = job.job_id
    inner join employer on job.employer_id = employer.employer_id 
    where saved_job.candidate_id = $candidate_id $search_part1 $search_part2 $search_part3 LIMIT $offset , $limit") or die(mysqli_error($jobConn));
...
<main class="d-flex">
    ...
    <div class="d-flex flex-column flex-shrink-0 p-3 text-white side-bar side-bar-sticky side-bar-hide active-side-bar"
        ...
        <ul class="nav nav-pills flex-column mb-auto">
            ...
            <li>
                <?php echo "<a href=\"" . ROOT_URL . "candidate/saved_jobs?id=$_SESSION[user_id]\" class=\"nav-link bg-danger active\" aria-current=\"page\">" ?>
                ...
                <form class="row container-fluid d-flex justify-content-center" method="post" action="<?php echo htmlspecialchars($_SERVER['REQUEST_URI']); ?>">
                    ...
                    <div class="col-sm-2 col-sm-2 search-bar-mobile-view">
                        <select class="form-select" aria-label="Default select example" name="status_search" id="status_search">
                            ...
                            <option value="1" <?php if($status_search == "1"){echo "selected=\"selected\"";}?>>Active</option>
                            ...
                            <?php $i = 1; while($row = mysqli_fetch_array($result)):?>
                                <tr>
                                    ...
                                    <td style="text-align: center;">
                                        ...
                                        <a class="btn btn-sm btn-soft-primary pencil-bg" href="../job-post?id=<?php echo $job_id ?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye" viewBox="0 0 16 16">
                                                <path d="M16 8s-3-5.5-8-5.5S0 8 0 8s3 5.5 8 5.5S16 8 16 8zM1.173 8a13.133 13.133 0 0 1 1.66-2.043C4.12 4.668 5.88 3.5 8 3.5c2.12 0 3.879 1.168 5.168 2.457A13.133 13.133 0 0 1 14.828 8c-.058.087-.122.183-.195.288-.335.48-.83 1.12-1.465 1.755C11.879 11.332 10.119 12.5 8 12.5c-2.12 0-3.879-1.168-5.168-2.457A13.134 13.134 0 0 1 1.172 8z" />
                                                    <path d="M8 5.5a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5zM4.5 8a3.5 3.5 0 1 1 7 0 3.5 3.5 0 0 1-7 0z" />
                                                </svg>
                                        </a>
                                        <a onclick="return confirm('Are you sure you want to delete this saved job?'); return false;" class="btn btn-sm btn-soft-danger deleteTrash"
                                        href="delete_savedjob.php?job_id=<?php echo $job_id?>&user_id=<?php echo $id ?>" >
                                        ...
                                        <div class="deleteborder">
                                            <div class="modal-body px-4 py-5 text-center w-auto ">
                                                ...
                                                <div class="hstack gap-2 justify-content-center mb-0">
                                                    <button type="button" class="btn btn-danger" href="delete_savedjob.php?job_id=<?php echo $job_id?>">Delete Now</button>
