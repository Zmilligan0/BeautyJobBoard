...
<main class="d-flex">
    ...
    <div class="d-flex flex-column flex-shrink-0 p-3 text-white side-bar side-bar-sticky side-bar-hide active-side-bar"
        ...
        <ul class="nav nav-pills flex-column mb-auto">
            ...
            <li class="nav-item">
                <!-- <a href="login-security" class="nav-link active" aria-current="page"> -->
        ...
        <div class="container mt-5">
            <div class="card main-card mx-auto m-5 d-block ">
                ...
                <div class="card-body">
                    ...
                    <h4 class="p-4">Account Access</h4>
                    <div class="d-flex justify-content-between border-bottom px-4">
                        <p class="text-muted">
                            <a class="text-decoration-none text-black" href="email-address">
                            <?php echo "<a class=\"text-decoration-none text-black\" href=\"" . ROOT_URL . "candidate/email-address?id=$_SESSION[user_id]\">" ?>
                            Email address</a>
                        </p>
                        <div>
                            <?php echo "<a href=\"" . ROOT_URL . "candidate/email-address?id=$_SESSION[user_id]\">" ?>
                                <svg style="color: rgb(97, 97, 97);" xmlns="http://www.w3.org/2000/svg" width="16"
                    ...
                    <div class="d-flex justify-content-between border-bottom px-4 mt-3">
                        <p class="text-muted">
                            <!-- <a class="text-decoration-none text-black" href="phone-number"> -->
                            <?php echo "<a class=\"text-decoration-none text-black\" href=\"" . ROOT_URL . "candidate/phone-number?id=$_SESSION[user_id]\">" ?>
                                Phone number</a>
                        </p>
                        <div>
                            <!-- <a href="phone-number"> -->
                            <?php echo "<a href=\"" . ROOT_URL . "candidate/phone-number?id=$_SESSION[user_id]\">" ?>
                                <svg style="color: rgb(97, 97, 97);" xmlns="http://www.w3.org/2000/svg" width="16"
                                    height="16" fill="currentColor" class="bi bi-arrow-right" viewBox="0 0 16 16">
                                    <path fill-rule="evenodd"
                                        d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8z"
                    ...
                    <div class="d-flex justify-content-between px-4 mt-3">
                        <p class="text-muted">
                            <!-- <a class="text-decoration-none text-black" href="change-password"> -->
                            <?php echo "<a class=\"text-decoration-none text-black\" href=\"" . ROOT_URL . "candidate/change-password?id=$_SESSION[user_id]\">" ?>
                                Change password</a>
                        </p>
                        <div>
                            <!-- <a href="change-password"> -->
                            <?php echo "<a href=\"" . ROOT_URL . "candidate/change-password?id=$_SESSION[user_id]\">" ?>
                                <svg style="color: rgb(97, 97, 97);" xmlns="http://www.w3.org/2000/svg" width="16"
                                    height="16" fill="currentColor" class="bi bi-arrow-right" viewBox="0 0 16 16">
                                    <path fill-rule="evenodd"
                                        d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8z"
                    ...
                    <!-- <div class="d-flex justify-content-between px-4 mt-3">
                        <p class="text-muted"><a class="text-decoration-none text-black"
                                href="dash-two-step-v">Two-step verification</a></p>
                        <div>
                            <a href="dash-two-step-v">
                                <svg style="color: rgb(97, 97, 97);" xmlns="http://www.w3.org/2000/svg" width="16"
                                    height="16" fill="currentColor" class="bi bi-arrow-right" viewBox="0 0 16 16">
                                    <path fill-rule="evenodd"
                                        d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8z"
