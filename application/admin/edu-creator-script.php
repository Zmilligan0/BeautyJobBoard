...
if (isset($_POST['submit'])) {
    ...
    try {
        ...
        if (count($errorList) > 0) {
            ...
            $resource_query = "INSERT into `resource` (resource_title, description, content, category_id, date_created, tags) VALUES ('$sanitized_edu_title','$sanitized_edu_description','$sanitized_edu_content','$sanitized_edu_category','$sanitized_edu_date','$sanitized_edu_tags')";
