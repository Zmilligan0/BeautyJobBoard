...
<?php
    $accl = "0,0";
    $pageTitle = "Add Educational Resource";
...
<main>
    <div class="d-flex">
        ...
        <div class="container-fluid p-5 pt-1">
            <!-- header -->
            <div class="mt-3 mb-3">
                <h2>Education Resource Management</h2>
            </div>
            <!-- job list sections -->
            <div class="card mb-4">
            ...
            <div class=" p-3 container p-5 pt-1">
                ...
                <form class="form" name="myForm" method="post" action="edu-creator-script.php" onsubmit="return validateForm()">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md">
                            ...
                            <input type="date" class="form-control" id="date-selection" name="date-selection" class="d-block" min="2001-01-01">
                    ...
                    <textarea class="form-control" name="description" style="min-height: 10rem;max-height: 10rem;"></textarea>
