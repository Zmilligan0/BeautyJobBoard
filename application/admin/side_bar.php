<?php
  ...
  {
    $url_array =  explode('/', $_SERVER['REQUEST_URI'])[4];
    $url = explode('.', $url_array)[0];
    if ($currect_page == $url) {
      echo 'active bg-danger'; //class name in css 
    } else {
      echo 'text-white';
    }
  }
...
<div class="d-flex flex-column flex-shrink-0 p-3 text-white side-bar side-bar-sticky side-bar-hide active-side-bar" style="width: 280px;" id="try">
  ...
  <ul class="nav nav-pills flex-column mb-auto">
    <li>
      <a href="candidate.php" class="nav-link  <?php active('candidate'); ?>">
    ...
    <li class="nav-item">
      <a href="salon.php" class="nav-link <?php active('salon'); ?>">
    ...
    <li>
      <a href="job.php" class="nav-link <?php active('job'); ?>">
    ...
    <li>
      <a href="application.php" class="nav-link <?php active('application'); ?>">
    ...
    <li>
      <a href="education.php" class="nav-link <?php active('education'); ?>">
    ...
    <li>
      <a href="newadmin.php" class="nav-link <?php active('newadmin'); ?>">
    ...
    <li>
      <a href="reported-users.php" class="nav-link <?php active('reported-users'); ?>">
    ...
    <?php
    function edit($currect_page)
    {
      $url_array =  explode('/', $_SERVER['REQUEST_URI']);
      $url = end($url_array);
      if ($currect_page == $url) {
        echo 'dont-show'; //class name in css 
      } else {
        echo 'showEditNav';
      }
    }
