            ...
            <div class="card main-card mx-auto m-5 d-block ">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between border-bottom px-4">
                        <p class="text-muted">
                            <a class="text-decoration-none text-black" href="includes/email-address?id=<?php echo $id ?>">
                               <a class="text-decoration-none text-black"  href="includes/email-address?id=<?php echo $id ?>">
                                Email address</a>
                        </p>
                        <div>
                        <a class="text-decoration-none text-black" href="">
                            <svg style="color: rgb(97, 97, 97);" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right" viewBox="0 0 16 16">
                                <path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8z" fill="#616161"></path>
                            </svg>
                            </a>
                        </div>
                    </div>
                    <div class="d-flex justify-content-between border-bottom px-4 mt-3">
                        <p class="text-muted">
                            ...
                            <a class="text-decoration-none text-black" href="includes/phone-number?id=<?php echo $id ?>">
                            Phone numbers</a>
                        </p>
                        <div>
                            <!-- <a href="phone-number"> -->
                    ...
                    <div class="d-flex justify-content-between px-4 mt-3">
                        <p class="text-muted">
                            ...
                            <a class="text-decoration-none text-black" href="includes/change-password?id=<?php echo $id ?>">
                            Change password</a>
                        </p>
                        <div>
